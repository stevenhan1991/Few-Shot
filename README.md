...
The format of the confile file can be found at configs folder. We have uploaded four .yaml files for vortex, ionization (PD), combustion (MF), and argonne bubble for reference.
